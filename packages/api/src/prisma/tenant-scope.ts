...
export const VENUE_SCOPED_MODELS: ReadonlySet<string> = new Set([
  ...
  'FloorPlan', 'FloorTable', 'Guest', 'GuestCrmNote', 'GuestHouseholdLink', 'InventoryRecipe', 'Invite', 'Invoice', 'LogbookEntry', 'ManagerGoal', 'Message', 'NotificationEvent',
  'NotificationRead', 'PaymentMethod', 'PayrollConnection', 'PayrollEmployeeMap', 'PayrollExport', 'PayrollTimeSheetPush', 'PosAggregatorChannel', 'PosCheck', 'PosConnection', 'PosInventoryConsumption',
