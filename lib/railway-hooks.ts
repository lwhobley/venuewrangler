...
const queryRoutes: Record<string, Route> = {
  ...
  'pos.getAggregatorCapabilities': { path: '/v1/pos/aggregator/capabilities' },
...
const mutationRoutes: Record<string, Route> = {
  ...
  'pos.upsertPosConnection': { path: '/v1/pos/connections', method: 'POST', body: ({ provider, externalLocationId, status }) => ({ provider, externalLocationId, status }), invalidate: [['pos', 'getPosOverview'], ['pos', 'getAggregatorStatus']] },
  'pos.createAggregatorChannel': { path: '/v1/pos/aggregator/channels', method: 'POST', body: stripVenue, invalidate: [['pos', 'getAggregatorChannels']] },
  'pos.sync86Broadcast': { path: '/v1/pos/aggregator/sync-86', method: 'POST', body: ({ itemNames, category, reason }) => ({ itemNames, category, reason }) },
  ...
  'guests.upsertGuest': { path: '/v1/guests', method: 'POST', body: stripVenue, invalidate: [['guests', 'listGuests'], ['guests', 'getGuestProfile']] },
  'guests.ingestLeads': { path: '/v1/guests/ingest-leads', method: 'POST', body: ({ leads }) => ({ leads }), invalidate: [['guests', 'listGuests']] },
  'guests.removeGuest': { path: (args) => `/v1/guests/${enc(args.guestId ?? args.id ?? args)}`, method: 'DELETE', invalidate: [['guests', 'listGuests'], ['guests', 'getGuestProfile']] },
  'guests.addGuestNote': { path: (args) => `/v1/guests/${enc(args.guestId)}/notes`, method: 'POST', body: ({ kind, text, occurredOn }) => ({ kind, text, occurredOn }), invalidate: [['guests', 'getGuestProfile'], ['guests', 'listGuests']] },
  'guests.removeGuestNote': { path: (args) => `/v1/guests/${enc(args.guestId)}/notes/${enc(args.noteId)}`, method: 'DELETE', invalidate: [['guests', 'getGuestProfile']] },
  'guests.addHouseholdLink': { path: (args) => `/v1/guests/${enc(args.guestId)}/household`, method: 'POST', body: ({ otherGuestId, relationship }) => ({ otherGuestId, relationship }), invalidate: [['guests', 'getGuestProfile']] },
  'guests.removeHouseholdLink': { path: (args) => `/v1/guests/${enc(args.guestId)}/household/${enc(args.linkId)}`, method: 'DELETE', invalidate: [['guests', 'getGuestProfile']] },
  ...
  'crm.createBeoDeposit': { path: (args) => `/v1/crm/beos/${enc(args.beoId)}/deposit`, method: 'POST', body: () => ({}) },
  'crm.waiveBeoDeposit': { path: (args) => `/v1/crm/beos/${enc(args.beoId)}/deposit/waive`, method: 'POST', body: () => ({}) },
  'crm.emailBeo': {
  ...
  'reservations.createDepositCheckout': { path: (args) => `/v1/reservations/${enc(args.reservationId)}/deposit`, method: 'POST', body: () => ({}), invalidate: [['reservations', 'getReservationsPage']] },
  'reservations.waiveDeposit': { path: (args) => `/v1/reservations/${enc(args.reservationId)}/deposit/waive`, method: 'POST', body: () => ({}), invalidate: [['reservations', 'getReservationsPage']] },
  ...
  'payroll.gustoAuthorize': { path: '/v1/payroll/gusto/authorize', method: 'POST', body: () => ({}) },
  'payroll.pushGusto': { path: '/v1/payroll/gusto/push', method: 'POST', body: stripVenue },
  'payroll.mapGustoEmployee': { path: '/v1/payroll/gusto/mappings', method: 'POST', body: stripVenue },
  'payroll.authorizeProvider': { path: '/v1/payroll/connect/authorize', method: 'POST', body: stripVenue },
  'payroll.pushProvider': { path: '/v1/payroll/connect/push', method: 'POST', body: stripVenue },
  'payroll.mapProviderEmployee': { path: '/v1/payroll/connect/mappings', method: 'POST', body: stripVenue },
